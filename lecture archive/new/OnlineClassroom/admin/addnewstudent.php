...
<div class="container">
	...
	<div class="row">
		...
		if ( isset( $_POST[ 'addnews' ] ) ) {
			...
			$tempsemester = $_POST[ 'semester' ];
			$tempphno = $_POST[ 'phno' ];
			$tempeid = $_POST[ 'email' ];
			$temppass = $_POST[ 'pass' ];
			//adding new student into database SQL Query
			$sql = "Insert into studenttable (FName, LName, FaName, DOB, Addrs, Gender, Course,Semester, PhNo , Eid, Pass) values ('$tempfname', '$templname', '$tempfaname', '$tempdob', '$tempaddrs' , '$tempgender', '$tempcourse','$tempsemester' , $tempphno, '$tempeid' , '$temppass')";
