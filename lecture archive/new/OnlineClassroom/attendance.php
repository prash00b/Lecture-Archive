			...
			<fieldset>
				...
				<form action="" method="POST" name="AddAssessment">
					<table class="table table-hover">
						...
						<td><button type="submit" name="submit" class="btn btn-success" style="border-radius:0%">Add Assignment</button>
						</td>
						
						<td><a href="assignmnet.php"><input type="button" Value="Back" class="btn btn-info btn-sm" style="border-radius:0%;"></a></td>
