...
if (isset($_POST['upload'])) {
	...
	$pdf_store="uploadassignments/".$pdf;
	move_uploaded_file($pdf_temp_loc,$pdf_store);
	$sql="INSERT INTO uploaded_assignment (name) VALUES ('$pdf')";
...
<body>
	<div class="file__upload">
		...
		<form action="insertassignment.php" method="POST" enctype="multipart/form-data" class="body">
			<!-- Sharable Link Code -->
