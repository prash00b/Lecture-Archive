...
if (isset($_POST['upload'])) {
	...
	$pdf_store="attendance/".$pdf;
	move_uploaded_file($pdf_temp_loc,$pdf_store);
	$sql="INSERT INTO uploaded_attendance (name) VALUES ('$pdf')";
...
<body>
	<div class="file__upload">
		...
		<form action="attendanceupload.php" method="POST" enctype="multipart/form-data" class="body">
			<!-- Sharable Link Code -->
